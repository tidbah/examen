/* 
Créer un script C permettant de lister des recommandations de livres en deux versions : une version développeur pour ajouter de nouveaux éléments (en langage C) et une version utilisateur pour les consulter (en Python).

Les fonctionnalités attendues sont les suivantes :

* Ajouter, modifier ou supprimer les informations de chaque livre (titre, auteur, genre, année de publication, etc.).
* Afficher les informations sur l'ensemble des livres, y compris des statistiques telles que le nombre total de livres disponibles et la moyenne des évaluations des utilisateurs.
* Rechercher un livre en utilisant différents critères tels que le titre, l'auteur, le genre, etc.
* Le fichier offre la possibiltié de générer un fichier csv qui sera consultable à l'aide du script python nommé consultation.py
*/
...
int main() {
    ...
    do {
        ...
        printf("7. Générer le fichier CSV\n");
        printf("8. Quitter\n");
